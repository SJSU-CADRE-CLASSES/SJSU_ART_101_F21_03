...
let projectiles = [];
let bg;
let img, img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12, img13, img14, img15, img16, img17, img18, img19;
let state = 'title';
let canvas;
let w = 800
let h = 800
...
function preload(){
  ...
  img13 = loadImage("assests/Textbox9.png")
  img14 = loadImage("assests/Textbox10.png")
  img15 = loadImage("assests/Textbox11.png")
  img16 = loadImage("assests/UE.png")
  img17 = loadImage("assests/Textbox12.png")
  img18 = loadImage("assests/Textbox13.png")
  img19 = loadImage("assests/Textbox14.png")
}
...
switch (state){
  ...
  case 'Text 9':
              //execute code
              Text9();
              canvas.mouseClicked(Text9MouseClicked);
              break;
  case 'Text 10':
              //execute code
              Text10();
              canvas.mouseClicked(Text10MouseClicked);
              break;
  case 'Text 11':
              //execute code
              Text11();
              canvas.mouseClicked(Text11MouseClicked);
              break;
  case 'UE':
                //execute code
                UE();
                canvas.mouseClicked(UEMouseClicked);
                break;
  case 'Text 12':
                //execute code
              Text12();
              canvas.mouseClicked(Text12MouseClicked);
              break;
  case 'Text 13':
                //execute code
              Text13();
              canvas.mouseClicked(Text13MouseClicked);
              break;
  case 'Text 14':
               //execute code
              Text14();
              canvas.mouseClicked(Text14MouseClicked);
              break;
  case 'you win':
youWin();
